...
| `Ctrl+Shift+T` | `Control+Shift+T` | Open the **Term Picker** dialogue (list-based) |
...
{% hint style="info" %}
Terms beyond 45 have no keyboard shortcut. Use the **TermLens popup** (tap `Ctrl`) or the **Term Picker** dialogue (`Ctrl+Shift+T`) to insert them.
{% endhint %}
